...
const mockGrid = [
  ...
  [{val: '15'}, {val: '29'}, {val: '20'}, {val: '44'}, {val: '55'}, {val: '66'}, {val: '77'}]  // Row 8
];

const res = parseAndSearchChart('open to open same and close to close one down between 1 to 4 row', mockGrid, 7);
